                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <span class="input-group-addon input-lg"><i class="fa fa-barcode"
                                                            aria-hidden="true"> &nbsp &nbsp CODIGO BARRA</i></span>
                                        ...
                                        <div class="col-lg-6" style="display:none; " id="mesAbonado">
                                            <div class="form-group">
                                                <select type="text" class="form-control multiselect multiselect-icon"
                                                    style="font-size:18px; height:46px; width:145px;"
                                                    role="multiselect">
                                                    <option value="0" data-icon="glyphicon-picture" selected="selected">
                                                        MES</option>
                                                    <option value="6" data-icon="glyphicon-link">JUNIO</option>
                                                    <option value="7" data-icon="glyphicon-pencil">AGOSTO</option>
                                                    <option value="8" data-icon="glyphicon-shopping-cart">SETIEMBRE
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <select type="text" class="form-control multiselect multiselect-icon"
                                                    ...
                                                    style="font-size:18px; height:46px; width:145px;"
                                                    role="multiselect">
                                                    <option value="EFECTIVO" data-icon="glyphicon-picture"
                                                        selected="selected">EFECTIVO</option>
                                                    <option value="TARJETA CREDITO" data-icon="glyphicon-link">T.
                                                        CREDITO</option>
                                                    <option value="TARJETA DEBITO" data-icon="glyphicon-pencil">T.
                                                        DEBITO</option>
                                                    <option value="YAPE" data-icon="glyphicon-shopping-cart">YAPE
                                                    </option>
                                                    <option value="PLIN" data-icon="glyphicon-shopping-cart">PLIN
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div id="bloque" style="display:none;">
                                    ...
                                    <div id="datos-chat">
                                        <div id="contenedor" class="notificacionTarea " style="background:#F7F6F4;">
                                            <div><span style="color:#1c62c4; font-size:15px;">PLACA: <span
                                                        style="color:#000;" id="placaVehiculo"></span></span></div>

                                            <div class="row" id="muestraClienteNormalEstacionamiento">

                                                <div class="col-lg-4"><span
                                                        style="color:#1c62c4; font-size:15px;">INGRESO: <span
                                                            style="color:#000;"
                                                            id="fechaHoraIngresoVehicular"></span></span></div>
                                                <div class="col-lg-4"><span
                                                        style="color:#1c62c4; font-size:15px;">SALIDA: <span
                                                            style="color:#000;"
                                                            id="fechaHoraSalidaVehicular"></span></span></div>
                                                <div class="col-lg-4"><span
                                                        style="color:#1c62c4; font-size:15px;">MONTO: <span
                                                            style="color:#000;" id="montoDetalle"></span></span></div>
                                    ...
                                    <table class="table table-bordered table-striped dt-responsive" width="90%">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="btn-group">
                                                        <button class="btn btn-success btn-xl btnBoletaFactura"
                                                            estadoBoleta="0" style="display:none;">BOLETA</button>
                                                    </div>
                                                </td>
                                                ...
                                                <td><input type="text" class="form-control input" id="cantidadHoras">
                                                </td>
                                    ...
                                    <div id="datosFactura" style="display:none;">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control input-lg col-lg-1"
                                                    id="rucCliente" required>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon input-lg"> &nbsp &nbsp Razon social:
                                                </span>
                                                <input type="text" class="form-control input-lg" id="razonSocialCliente"
                                                    required>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon input-lg"> &nbsp &nbsp Direccion fiscal:
                                                </span>
                                                <input type="text" class="form-control input-lg"
                                                    id="direccionFiscalCliente">
                                    ...
                                    <div id="datosBoleta">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-addon input-lg"> &nbsp &nbsp Direccion :
                                                </span>
                                                <input type="text" class="form-control input-lg"
                                                    id="direccionDniCliente">
                                                <input type="hidden" id="montoReal">
                                                <input type="hidden" id="tipoDocumento">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon" id="mostrarBtnPagar"><button
                                                    class="btn btn-success btn-xl" id="btnPagar">PAGAR</button></span>
