...
class ControladorPago{
	...
	/*============================================   
	ACTUALIZAR PAGO DE PARQUEO COMPLETO
	=============================================*/ 
	...
	static public function ctrActualizarPagoParqueoAcumulado($valor){
	 ...
	 /*============================================        
	REGISTRAR ACUMULADO DE PARQUEO 
	=============================================*/ 

	static public function ctrRegistrarAcumuladoParqueo($valor){

		$tabla = "detalleestacionamiento";
		$respuesta = ModeloPago::mdlRegistrarAcumuladoParqueo($tabla,$valor);
